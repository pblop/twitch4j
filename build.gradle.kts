...
subprojects {
	...
	dependencies {
		constraints {
			...
			// HTTP
			api(group = "com.squareup.okhttp3", name = "okhttp", version = "5.3.2")
		...
		withType<Javadoc> {
			options {
				...
				links(
						...
						// "https://javadoc.io/doc/com.squareup.okhttp3/okhttp/5.3.2", // blocked by https://github.com/square/okhttp/issues/6450
						...
						"https://javadoc.io/doc/com.fasterxml.jackson.core/jackson-databind/2.20.1",
						"https://javadoc.io/doc/com.fasterxml.jackson.core/jackson-core/2.20.1",
